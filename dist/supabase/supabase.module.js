...
const supabase_admin_service_1 = require("./supabase-admin.service");
...
exports.SupabaseModule = SupabaseModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [supabase_admin_service_1.SupabaseAdminService],
        exports: [supabase_admin_service_1.SupabaseAdminService],
    })
], SupabaseModule);
